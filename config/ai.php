...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Used by ModelHealthService for the retirement circuit breaker and the
    | model-fallback ladder per provider (see providers.*.models below).
    |
    */
    ...
    'providers' => [
        'anthropic' => [
            ...
            'models' => [
                ...
                'strong' => env('ANTHROPIC_MODEL', 'claude-sonnet-4-6'),
                'backup' => env('ANTHROPIC_MODEL_BACKUP', 'claude-opus-4-8'),
            ],
        ],
