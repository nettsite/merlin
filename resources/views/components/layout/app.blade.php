...
<body class="font-sans antialiased">
    ...
    <flux:sidebar sticky collapsible="mobile" class="bg-surface-alt border-r border-line">
        ...
        <flux:dropdown position="top" align="start" class="max-lg:hidden">
            ...
            <flux:menu>
                ...
                <flux:menu.item
                    ...
                    x-on:click="document.getElementById('sidebar-logout-form').submit()"
                >
                    Log out
                </flux:menu.item>
            </flux:menu>
    ...
    {{-- Mobile top bar --}}
    <flux:header class="lg:hidden bg-white border-b border-line">
        <flux:sidebar.toggle icon="bars-2" inset="left" />
        <a href="{{ route('dashboard') }}" wire:navigate class="mx-auto">
            <x-application-logo :height="24" />
        </a>
    </flux:header>
